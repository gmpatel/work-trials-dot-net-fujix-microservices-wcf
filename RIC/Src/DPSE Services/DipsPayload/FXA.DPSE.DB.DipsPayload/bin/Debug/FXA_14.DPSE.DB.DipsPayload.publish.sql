...
GO
PRINT N'Creating [dbo].[PayloadDetails]...';
...
GO
ALTER TABLE [dbo].[PayloadDetails]
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '24d591c2-414c-4fb7-ad29-a4aa382ab5eb')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('24d591c2-414c-4fb7-ad29-a4aa382ab5eb')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '954bc547-c8e0-4e17-b44e-4cbc8ea5757f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('954bc547-c8e0-4e17-b44e-4cbc8ea5757f')
...
BEGIN
  ...
  Insert Into PayloadDetails Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
  Insert Into PayloadDetails Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
  Insert Into PayloadDetails Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
  Insert Into PayloadDetails Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
  Insert Into PayloadDetails Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
