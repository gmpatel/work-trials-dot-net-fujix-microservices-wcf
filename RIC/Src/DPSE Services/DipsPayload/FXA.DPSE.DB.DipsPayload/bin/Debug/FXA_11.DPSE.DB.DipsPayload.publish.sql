...
BEGIN
  ...
  Insert Into Payloads Values ((Select isnull(max(TransactionId), 0) From Payloads) + 1, 1, GETDATE(), '\Payloads\Payload1', 0, NULL, 0, NULL)
  ...
  Insert Into Payloads Values ((Select isnull(max(TransactionId), 0) From Payloads) + 1, 1, GETDATE(), '\Payloads\Payload2', 0, NULL, 0, NULL)
  Set @PayloadId = @@Identity
  Insert Into PayloadCheques Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select isnull(max(ReferenceTrackingNumber), 0) From PayloadCheques) + 1)
