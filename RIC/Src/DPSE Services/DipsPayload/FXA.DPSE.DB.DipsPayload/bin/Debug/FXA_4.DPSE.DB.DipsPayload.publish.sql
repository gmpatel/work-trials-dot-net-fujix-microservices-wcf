...
BEGIN
  ...
  Insert Into Payloads Values ((Select max(TransactionId) From Payloads) + 1, 1, GETDATE(), '\Payloads\Payload1', 0, NULL)
  Set @PayloadId = @@Identity
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
  ...
  Insert Into Payloads Values ((Select max(TransactionId) From Payloads) + 1, 1, GETDATE(), '\Payloads\Payload2', 0, NULL)
  Set @PayloadId = @@Identity
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
  Insert Into PayloadCheques Values (@PayloadId, (Select max(ReferenceTrackingNumber) From PayloadCheques) + 1)
