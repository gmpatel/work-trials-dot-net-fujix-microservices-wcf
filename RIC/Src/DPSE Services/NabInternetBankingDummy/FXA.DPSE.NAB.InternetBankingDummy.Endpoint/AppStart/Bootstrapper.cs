...
namespace FXA.DPSE.NAB.InternetBankingDummy.Endpoint.AppStart
{
    public static class Bootstrapper
    {
        ...
        public static IContainer ConfigureContainer()
        {
            ...
            cb.RegisterType<InternetBankingDummyService>().As<IInternetBankingDummyService>();
        ...
        {
            RouteTable.Routes.Add(new ServiceRoute("nab", new RestServiceHostFactory<IInternetBankingDummyService>(), typeof(IInternetBankingDummyService)));
        }
    }
}