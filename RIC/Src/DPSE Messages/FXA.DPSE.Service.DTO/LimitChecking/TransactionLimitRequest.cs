...
namespace FXA.DPSE.Service.DTO.LimitChecking
{
    [DataContract]
    public class TransactionLimitRequest
    {
        ...
        public TransactionLimitRequest(string trackingId)
        {
            TrackingId = trackingId;
        }

        public TransactionLimitRequest(string trackingId, string channelType, string sessionId, Cheque[] cheques)
        {
            TrackingId = trackingId;
